...
var _assertThisInitialized2 = _interopRequireDefault(__webpack_require__(647));

var _inheritsLoose2 = _interopRequireDefault(__webpack_require__(700));

var _extends2 = _interopRequireDefault(__webpack_require__(398));

var _propTypes = _interopRequireDefault(__webpack_require__(615));

var _react = _interopRequireDefault(__webpack_require__(492));

var _reachRouter = __webpack_require__(271);

var _utils = __webpack_require__(37);

var _parsePath = __webpack_require__(956);
...
var _scrollHandler = __webpack_require__(881);

__webpack_unused_export__ = _scrollHandler.ScrollHandler;

var _useScrollRestoration = __webpack_require__(90);
...
var React = _interopRequireWildcard(__webpack_require__(492));
...
var _react = __webpack_require__(492);
...
//   },
// ]
const apis=__webpack_require__(360);function augmentErrorWithPlugin(plugin,err){if(plugin.name!==`default-site-plugin`){// default-site-plugin is user code and will print proper stack trace,
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(492);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(615);
...
// EXTERNAL MODULE: external "/Users/andrew/Documents/GitHub/node_modules/react/index.js"
var index_js_ = __webpack_require__(492);
var index_js_default = /*#__PURE__*/__webpack_require__.n(index_js_);
// EXTERNAL MODULE: ../node_modules/prop-types/index.js
var prop_types = __webpack_require__(615);
var prop_types_default = /*#__PURE__*/__webpack_require__.n(prop_types);
// EXTERNAL MODULE: ../node_modules/gatsby-link/index.js
var gatsby_link = __webpack_require__(303);
// EXTERNAL MODULE: ../node_modules/gatsby-react-router-scroll/index.js
var gatsby_react_router_scroll = __webpack_require__(727);
// EXTERNAL MODULE: ./.cache/public-page-renderer.js
var public_page_renderer = __webpack_require__(138);
...
var find_path = __webpack_require__(70);
...
var react_lifecycles_compat = __webpack_require__(828);
...
"use strict";
module.exports = require("/Users/andrew/Documents/GitHub/node_modules/react-dom/server.js");
...
"use strict";
module.exports = require("/Users/andrew/Documents/GitHub/node_modules/react/index.js");
...
"use strict";
module.exports = require("/Users/andrew/Documents/GitHub/plantracker/.cache/ssr-builtin-trackers/fs");
...
"use strict";
module.exports = JSON.parse('{"polyfill":["/polyfill-3d4f26b6f7ead8a54bee.js"],"app":["/app-6bc9c217dde998edde5e.js"]}');
...
/* harmony export */ });
const React=__webpack_require__(492);const path=__webpack_require__(423);const{renderToString,renderToStaticMarkup,pipeToNodeWritable}=__webpack_require__(84);const{ServerLocation,Router,isRedirect}=__webpack_require__(271);const merge=__webpack_require__(857);const{StaticQueryContext}=__webpack_require__(183);const fs=__webpack_require__(131);const{WritableAsPromise}=__webpack_require__(517);const{RouteAnnouncerProps}=__webpack_require__(478);const{apiRunner,apiRunnerAsync}=__webpack_require__(322);const asyncRequires=__webpack_require__(586);const{version:gatsbyVersion}=__webpack_require__(117);const{grabMatchParams}=__webpack_require__(70);const chunkMapping=__webpack_require__(804);// we want to force posix-style joins, so Windows doesn't produce backslashes for urls
const{join}=path.posix;// const testRequireError = require("./test-require-error")
// For some extremely mysterious reason, webpack adds the above module *after*
// this module so that when this code runs, testRequireError is undefined.
// So in the meantime, we'll just inline it.
const testRequireError=(moduleName,err)=>{const regex=new RegExp(`Error: Cannot find module\\s.${moduleName}`);const firstLine=err.toString().split(`\n`)[0];return regex.test(firstLine);};let Html;try{Html=__webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../src/html'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));}catch(err){if(testRequireError(`../src/html`,err)){Html=__webpack_require__(875);}else{throw err;}}Html=Html&&Html.__esModule?Html.default:Html;const getPageDataPath=path=>{const fixedPagePath=path===`/`?`index`:path;return join(`page-data`,fixedPagePath,`page-data.json`);};const getPageDataUrl=pagePath=>{const pageDataPath=getPageDataPath(pagePath);return`${""}/${pageDataPath}`;};const getStaticQueryPath=hash=>join(`page-data`,`sq`,`d`,`${hash}.json`);const getStaticQueryUrl=hash=>`${""}/${getStaticQueryPath(hash)}`;const getAppDataUrl=()=>`${""}/${join(`page-data`,`app-data.json`)}`;const createElement=React.createElement;const sanitizeComponents=components=>{const componentsArray=[].concat(components).flat(Infinity).filter(Boolean);return componentsArray.map(component=>{// Ensure manifest is always loaded from content server
